package JAVACORE_TRAINING.OBJECT_AND_CLASSES.XML_MODULES.XML_EXCERCISES.UPDATE;
...
public class UpdateData {
	public static void main(String[] args) {
		...
		/*
		 * - Dữ liệu trong XML Files :
		 * <Student id="2">
			    <iRollNo>SV002</iRollNo>
			    <sFullName>Trần Thị B</sFullName>
			    <dMark>7.5</dMark>
		    </Student>
		 * 
		 * - Dữ liệu cần cập nhật thành:
		 * <Student id="2">
			    <iRollNo>100</iRollNo>
			    <sFullName>Trần Thị Thanh Hằng</sFullName>
			    <dMark>9.5</dMark>
			</Student>
		 * */
		...
		if (returnVal == JFileChooser.APPROVE_OPTION) {
			...
			try{
				...
				boolean isResult = objController.
								XMLExecute(objXMLParam, (byte) 1);
				if(isResult){
					JOptionPane.showMessageDialog(null, "Cập nhật thành công!!!");
					int iOpt = JOptionPane.showConfirmDialog(null, 
							"Bạn có muốn xem dữ liệu sau cập nhật?",
							"Thông báo", 
