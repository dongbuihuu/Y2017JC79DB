...
public class EmployeeJSONWriter {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		/**
		 * We can get JsonWriter from JsonWriterFactory also JsonWriterFactory factory =
		 * Json.createWriterFactory(null); jsonWriter = factory.createWriter(os);
		 */
