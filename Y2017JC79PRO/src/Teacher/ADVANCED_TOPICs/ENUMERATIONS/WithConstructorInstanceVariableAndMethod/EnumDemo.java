package Teacher.ADVANCED_TOPICs.ENUMERATIONS.WithConstructorInstanceVariableAndMethod;
...
public class EnumDemo {
	...
	public static void main(String[] args) {
		...
		// System.out.println(objApple.PrintInfo());
		System.out.println(objApple.B.PrintInfo());
	}
}
