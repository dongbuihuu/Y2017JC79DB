	...
	public static void main(String[] args) {
		...
		try {
			...
			if(!objConnection.isClosed()){
				...
				objCmst.setString("FULLNAME", "Mộng Thị Thúy");
				objCmst.setString("EMAIL", "thuy.mong.thi@gmail.com");
				objCmst.setString("MOBILE", "0988888888");
				objCmst.setFloat("MARK", (float)8.5);
