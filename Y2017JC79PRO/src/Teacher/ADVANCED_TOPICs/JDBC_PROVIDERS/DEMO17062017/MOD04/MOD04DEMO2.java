	...
	public static void main(String[] args) {
		...
		try {
			...
			if(!objConnection.isClosed()){
				...
				objCmst.setString("FULLNAME", "Trần Thị Thúy");
				objCmst.setString("EMAIL", "thuytt@gmail.com");
				objCmst.setString("MOBILE", "099999999999");
				objCmst.setFloat("MARK", (float)10);
