	...
	public static void main(String[] args) {
		...
		try {
			...
			if (!objConnection.isClosed()) {
				...
				ResultSet objRs;
				// String sSQL = "Select EventName, Price, EventDay From
				// Events";
				objCmst = objConnection.prepareCall("{call SP_DanhSachSuKien200(?)}");
				
				//5. Thiết lập giá trị cho tham số truyền vào của Store Procedure
				objCmst.setInt("EventDay", 11);  //EventDay = 12
