...
public class ShareControllerOfGenerics {
    ...
    * */
    ...
    public static void main(String[] str) {
        ...
        // b. Not Okie
         //drawCircle(lisShape, lisShape); // Errors lisShap ko phai Circle hay kế thừa từ Cirle
        //drawOctagon(lisShape, lisShape); // Errors tuong tu
         //drawOctagon(objChildOc, objChildOc); // Errors chilOc ko phải là cha của OctagonEntity

        /*
         * Tổng kết: 
         * + ? extends T : Đối tượng ? phải kế thừa từ T hoặc là chính T. 
         * + ? super T: Đối tượng ? phải là đối tượng cha của T hoặc là chínhT 
         * (ko nhận các đối tượng con của T).
         */
    }
}
