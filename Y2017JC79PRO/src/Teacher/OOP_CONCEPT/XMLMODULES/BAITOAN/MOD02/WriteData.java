package Teacher.OOP_CONCEPT.XMLMODULES.BAITOAN.MOD02;
...
public class WriteData {
	public static void main(String[] args) {
		...
		do {
			...
			System.out.println(String.format("- Hiện có: %s Sinh viên trong danh sách!", lisStudent.size()));
		...
		if (returnVal == JFileChooser.APPROVE_OPTION) {
			...
			try {
				...
				XMLParams<Student> objXMLParam = new XMLParams<Student>();
