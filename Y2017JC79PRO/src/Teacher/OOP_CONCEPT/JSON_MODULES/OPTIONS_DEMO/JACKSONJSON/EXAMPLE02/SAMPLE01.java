...
public class SAMPLE01 {
	...
	public static void main(String[] args) {
		...
		HashMap<Integer, List<Student>> objHash = new HashMap<Integer, List<Student>>();
		...
		if (returnVal == JFileChooser.APPROVE_OPTION) {
			...
			// 5. Ghi dữ liệu Object Java xuống files JSON
			// writeValue(<đường dẫn tới file đã khởi tạo>,
			// <dữ liệu nguồn cần ghi xuống files>);
			try {
				objMap.writeValue(new File(FileName), objHash); // [{...},{...},...]
