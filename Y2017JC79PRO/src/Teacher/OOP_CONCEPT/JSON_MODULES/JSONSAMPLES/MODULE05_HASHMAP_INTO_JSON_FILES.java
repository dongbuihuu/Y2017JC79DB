...
public class MODULE05_HASHMAP_INTO_JSON_FILES {

	public static void main(String[] args) {
		// 1. Khai báo & khởi tạo danh sách Sinh Viên
		HashMap<Integer, List<Student>> objHashStudent = new HashMap<Integer, List<Student>>();
		...
		// 5. Đưa danh sách vào hashmap
		objHashStudent.put(0, lisStudent);

		// 6. Sử dụng comps có sẵn để xuất hiện cửa sổ cho phép lưu files
		...
		if (returnVal == JFileChooser.APPROVE_OPTION) {
			...
			// 7. Thực thi ghi dữ liệu danh sách xuống files *.json
			ObjectMapper objMapper = new ObjectMapper();
			try {
				objMapper.writeValue(new File(FileName), objHashStudent);
